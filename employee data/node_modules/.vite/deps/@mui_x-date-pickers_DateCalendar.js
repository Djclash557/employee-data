...
var useCalendarState = (params) => {
  ...
  const adapter = usePickerAdapter();
  const reducerFn = React14.useRef(createCalendarStateReducer(Boolean(reduceAnimations), adapter)).current;
...
function DefaultPropsProvider(props) {
  return (0, import_jsx_runtime6.jsx)(DefaultPropsProvider_default, {
    ...props
  });
}
...
var LazyRipple = class _LazyRipple {
  ...
  static use() {
    ...
    const [shouldMount, setShouldMount] = React29.useState(false);
    ripple.shouldMount = shouldMount;
    ripple.setShouldMount = setShouldMount;
    React29.useEffect(ripple.mountEffect, [shouldMount]);
    return ripple;
  }
  constructor() {
    this.ref = {
...
var usePickerPrivateContext = () => React34.useContext(PickerPrivateContext);
...
var PickersDayRaw = React36.forwardRef(function PickersDay(inProps, forwardedRef) {
  ...
  return (0, import_jsx_runtime11.jsx)(PickersDayRoot, _extends({
    ...
    ownerState,
    children: children2 ?? adapter.format(day, "dayOfMonth")
  }));
});
...
function WrappedDay(_ref) {
  ...
  const isOutsideCurrentMonth = React39.useMemo(() => adapter.getMonth(day) !== currentMonthNumber, [adapter, day, currentMonthNumber]);
  const ownerState = usePickerDayOwnerState({
    day,
    selected: isSelected,
    disabled: isDisabled,
...
function DayCalendar(inProps) {
  ...
  const validSelectedDays = React39.useMemo(() => selectedDays.filter((day) => !!day).map((day) => adapter.startOfDay(day)), [adapter, selectedDays]);
...
var MonthCalendarButton = React41.memo(function MonthCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var useControlledValue = ({
  ...
  const inputTimezone = React42.useMemo(() => valueManager.getTimezone(adapter, valueWithInputTimezone), [adapter, valueManager, valueWithInputTimezone]);
  ...
  const timezoneToRender = React42.useMemo(() => {
    if (timezoneProp) {
      return timezoneProp;
    }
    if (inputTimezone) {
  ...
  const valueWithTimezoneToRender = React42.useMemo(() => valueManager.setTimezone(adapter, timezoneToRender, valueWithInputTimezone), [valueManager, adapter, timezoneToRender, valueWithInputTimezone]);
...
var MonthCalendar = React44.forwardRef(function MonthCalendar2(inProps, ref) {
  ...
  const todayMonth = React44.useMemo(() => adapter.getMonth(now), [adapter, now]);
  const selectedMonth = React44.useMemo(() => {
    if (value != null) {
      return adapter.getMonth(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedMonth, setFocusedMonth] = React44.useState(() => selectedMonth || adapter.getMonth(referenceDate));
  ...
  const isMonthDisabled = React44.useCallback((dateToValidate) => {
...
var YearCalendarButton = React45.memo(function YearCalendarButton2(props) {
  const {
    autoFocus,
    classes: classesProp,
    disabled,
...
var YearCalendar = React46.forwardRef(function YearCalendar2(inProps, ref) {
  ...
  const todayYear = React46.useMemo(() => adapter.getYear(now), [adapter, now]);
  const selectedYear = React46.useMemo(() => {
    if (value != null) {
      return adapter.getYear(value);
    }
    return null;
  }, [value, adapter]);
  const [focusedYear, setFocusedYear] = React46.useState(() => selectedYear || adapter.getYear(referenceDate));
  const [internalHasFocus, setInternalHasFocus] = useControlled({
    name: "YearCalendar",
    state: "hasFocus",
    controlled: hasFocus,
  ...
  const isYearDisabled = React46.useCallback((dateToValidate) => {
...
function useViews({
  ...
  const previousOpenTo = React47.useRef(openTo);
  const previousViews = React47.useRef(views);
  const defaultView = React47.useRef(views.includes(openTo) ? openTo : views[0]);
  ...
  const defaultFocusedView = React47.useRef(autoFocus ? view : null);
...
var ClockIcon = createSvgIcon((0, import_jsx_runtime22.jsxs)(React52.Fragment, {
...
var TimeIcon = createSvgIcon((0, import_jsx_runtime22.jsxs)(React52.Fragment, {
  children: [(0, import_jsx_runtime22.jsx)("path", {
    d: "M11.99 2C6.47 2 2 6.48 2 12s4.47 10 9.99 10C17.52 22 22 17.52 22 12S17.52 2 11.99 2zM12 20c-4.42 0-8-3.58-8-8s3.58-8 8-8 8 3.58 8 8-3.58 8-8 8z"
  }), (0, import_jsx_runtime22.jsx)("path", {
    d: "M12.5 7H11v6l5.25 3.15.75-1.23-4.5-2.67z"
...
var PickersCalendarHeader = React55.forwardRef(function PickersCalendarHeader2(inProps, ref) {
  const translations = usePickerTranslations();
  const adapter = usePickerAdapter();
  const props = useThemeProps({
    props: inProps,
...
var DateCalendar = React56.forwardRef(function DateCalendar2(inProps, ref) {
  const adapter = usePickerAdapter();
  const {
    ownerState
  } = usePickerPrivateContext();
  ...
  const prevOpenViewRef = React56.useRef(view);
  React56.useEffect(() => {
  ...
  const selectedDays = React56.useMemo(() => [value], [value]);
